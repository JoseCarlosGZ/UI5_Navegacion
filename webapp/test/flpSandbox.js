		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comaccenturenavegacion_ui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaccenturenavegacion_ui-display": {
								"semanticObject": "comaccenturenavegacion_ui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.accenture.navegacion_ui",
									"url": sap.ui.require.toUrl("com/accenture/navegacion_ui")
								}
							}
						}
					}
